...
public final class QueryUtil {
    ...
    public static ArrayList<Earthquake> fetchJsonString(String requestURL) {
        ...
        try {
            ...
            Log.e("fetchJsonString", "IOException");
        }

        final ArrayList<Earthquake> earthquakes = QueryUtil.extractEarthquakes(response);
        return earthquakes;
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String JSON_RESPONSE) {
        ...
        try {
            ...
            while(i< feature.length()){
                JSONObject element = feature.getJSONObject(i);
                ...
                earthquakes.add(new Earthquake(place, dateToDisplay, mag, url));
                i++;
            }
